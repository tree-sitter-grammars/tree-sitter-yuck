...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [285] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(110),
  [288] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(110),
  ...
  [304] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat4, 2), SHIFT_REPEAT(114),
  [307] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat4, 2), SHIFT_REPEAT(114),
  ...
  [333] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat6, 2), SHIFT_REPEAT(113),
  [336] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat6, 2), SHIFT_REPEAT(113),
  [339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat3, 2),
  [341] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat3, 2), SHIFT_REPEAT(114),
  [344] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat3, 2), SHIFT_REPEAT(114),
  [347] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat5, 2),
  [349] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat5, 2), SHIFT_REPEAT(113),
  [352] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat5, 2), SHIFT_REPEAT(113),
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 1, .production_id = 1),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat4, 1, .production_id = 1),
  [359] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat6, 1, .production_id = 1),
  [361] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [363] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(110),
  [366] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(110),
  [369] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_interpolation, 3),
  [371] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_interpolation, 3),
  [373] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 1),
  [375] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 1),
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat5, 1),
  [379] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat5, 1),
  ...
  [385] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_json_array_repeat1, 2), SHIFT_REPEAT(14),
  [388] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [390] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [392] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [394] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_json_object_repeat1, 2),
  [396] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_json_object_repeat1, 2), SHIFT_REPEAT(10),
